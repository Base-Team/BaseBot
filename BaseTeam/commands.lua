...
serpent = (loadfile "./BaseTeam/libs/serpent.lua")()
feedparser = (loadfile "./BaseTeam/libs/feedparser.lua")()
json = (loadfile "./BaseTeam/libs/JSON.lua")()
mimetype = (loadfile "./BaseTeam/libs/mimetype.lua")()
redis = (loadfile "./BaseTeam/libs/redis.lua")()
JSON = (loadfile "./BaseTeam/libs/dkjson.lua")()
